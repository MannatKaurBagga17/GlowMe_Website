...
export const Route = createFileRoute("/search")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Verified makeup, hair, and nail artists at top studios." },
    ],
    links: [
      {
        rel: "stylesheet",
...
function SearchPage() {
  ...
  const filters = { city: city || undefined, category: category || undefined, query: query || undefined, minRating: minRating || undefined, maxPrice: maxPrice || undefined, studio: studio || undefined };
    ...
    <div className="gm-search-root">
      ...
      <section className="gm-hero">
        <div className="gm-container">
          ...
          <p className="gm-sub">Verified makeup, hair, nails & skincare at top studios.</p>
          ...
          {artists.map((a) => (
            <Link key={a.id} to="/artist/$slug" params={{ slug: a.slug }} className="gm-card">
              <div className="gm-card-img">
                ...
                <span className="gm-verified" style={{top:"auto",bottom:12,right:12,background:"rgba(201,169,110,0.9)",color:"#0a0807"}}>Studio Visit Only</span>
              </div>
