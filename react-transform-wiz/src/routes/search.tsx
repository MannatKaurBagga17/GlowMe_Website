...
function SearchPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="border-b border-border bg-gradient-to-b from-rose-50/60 to-background pb-10 pt-16">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="mt-6 grid gap-3 rounded-2xl border border-border bg-card p-4 md:grid-cols-[1fr_260px_180px_auto]">
            ...
            <div className="grid grid-cols-[1fr_auto] gap-2">
              <input value={city} onChange={(e) => setCity(e.target.value)} list="glowme-city-options" className="min-w-0 rounded-md border border-input bg-background px-3 py-2 text-sm" placeholder="Search location" />
              <select value={city} onChange={(e) => setCity(e.target.value)} className="rounded-md border border-input bg-background px-2 py-2 text-sm" aria-label="Choose city">
